...
rstan library. Stan performs Bayesian inference using Markov Chain Monte
Carlo See <https://mc-stan.org/users/interfaces/rstan>
...
### Compile results (Impulse Response Function)

### Analyses are valied only if autocorrelation of residuals is negligible, and for Bayesian inference, if there is a sign of convergence in MCMC
